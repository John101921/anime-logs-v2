  ...
  return (
    <div className="table-wrap">
      <table>
        <thead>
          <tr>
            <th className="select-cell"><span className="checkbox" /></th>
            <th>Event</th>
            <th>Player</th>
            <th>Cash</th>
            <th>Wave</th>
        ...
        <tbody>
          {rows.map((row, index) => (
            <tr key={row.id}>
              <td className="select-cell"><span className={index % 3 === 0 ? "checkbox checked" : "checkbox"} /></td>
              ...
              <td><Link className="action-dots" href={`/events/${row.id}`}>•••</Link></td>
            </tr>
          ))}
        </tbody>
      </table>
        ...
        <tbody>
          {rows.map((row, index) => (
            <tr key={row.id}>
              ...
              <td><Link className="action-dots" href={`/snapshots/${row.id}`}>•••</Link></td>
            </tr>
          ))}
        </tbody>
      </table>
